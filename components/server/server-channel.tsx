...
export const ServerChannel = ({ 
  ...
  // This 'Icon' gets replaced with the ones mentioned in the iconMap object
  ...
  // This is introduced because of the onClick function above, replacing the onClick attribute in elements
